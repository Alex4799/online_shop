...
<div class="container py-2">
    ...
    <h3 class=" py-2"><a href="{{route('user#homePage')}}" class=" text-decoration-none">Home</a>/ <a href="{{route('user#viewCategory',$product->category_id)}}" class=" text-decoration-none">{{$product->category_name}}</a> / View Post</h3>
